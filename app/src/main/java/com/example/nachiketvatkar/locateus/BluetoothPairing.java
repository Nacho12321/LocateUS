...
import com.example.nachiketvatkar.locateus.ble.BleDevicesScanner;
import com.example.nachiketvatkar.locateus.ble.BleManager;
import com.example.nachiketvatkar.locateus.ble.BleUtils;

public class BluetoothPairing extends ActionBarActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener {

    // Constants
    private final static String TAG = BluetoothPairing.class.getSimpleName();
...
//            intent.setClass(BluetoothPairing.this, SettingsActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BleUtils.enableWifi(true, BluetoothPairing.this);
                            BluetoothPairing.super.onBackPressed();
                        }
...
//                }
    ...
    private void launchComponentActivity() {
        ...
        showConnectionStatus(false);
        if (mComponentToStartWhenConnected != null) {
            Intent intent = new Intent(BluetoothPairing.this, mComponentToStartWhenConnected);
...
//                                    stopScanning();
//
//                                    mFirmwareUpdater.startFailedInstallationRecovery(BluetoothPairing.this);
//                                }
//                            })
//                            .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
//                                @Override
//                                public void onClick(DialogInterface dialog, int which) {
//                                    FirmwareUpdater.clearFailedInstallationRecoveryParams(BluetoothPairing.this);
...
//                                    mFirmwareUpdater.downloadAndInstall(BluetoothPairing.this, latestRelease);
//                                }
//                            })
